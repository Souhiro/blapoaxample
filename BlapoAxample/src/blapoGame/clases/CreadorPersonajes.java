...
public class CreadorPersonajes {
	...
	public static Personaje creaElaia() {
		...
		Hechizo wingedArmor = new Hechizo(4, "Armadura Alada", GameConst.MELEE, 30, 8, GameConst.EFECTO_ARMADURA, GameConst.EFECTO_VUELO);
		
		return new Personaje("Elaia Kessev", false, 8, 10, 9, 8, 7, 6, powerArmor, thamondBlade, thamondBladeTurbo, wingedArmor);
	}
	...
	public static Personaje creaHerry() {
		...
		return new Personaje("Herry Sotter", true, 8, 7, 6, 8, 9, 10, bowsie, geodude, yashichi, archer, nimbus);
	}
	...
	public static Personaje creaNurgle() {
		...
		Hechizo glimmerWing = new Hechizo(11, "Glimmer Wing", GameConst.MELEE, 0, 3, GameConst.EFECTO_VUELO, GameConst.EFECTO_VELOCIDAD);
		Hechizo dazzleBlade = new Hechizo(12, "Dazzle Blade", GameConst.MELEE, 40, 4);
		Hechizo swordRevealer = new Hechizo(13, "Sword of Revealing Light", GameConst.MELEE, 0, 5, GameConst.EFECTO_ANTIILUSIONES, GameConst.EFECTO_RETURNER);
		Hechizo pudreMentes = new Hechizo(14, "Flashing Panty", GameConst.MENTAL, 30, 6, GameConst.EFECTO_SILENCIAR);
		
		return new Personaje("Nurgle Luzpodrida", false, 8, 8, 9, 7, 10, 6, lightKick, glimmerWing, dazzleBlade, swordRevealer, pudreMentes);
	}
}
